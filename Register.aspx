...
<body>
    ...
    <div class="card-header text-center ">
        <i class="fa fa-sign-in fa fa-2x  "></i></div>
        <div class="card-body">
            ...
            <tr>
                ...
                <td class="auto-style8">
                    ...
                    <asp:TextBox ID="txtPassword" runat="server"  CssClass="form-control is-valid" TextMode="Password" required=""></asp:TextBox>
                        <ajaxToolkit:PasswordStrength ID="txtPassword_PasswordStrength" runat="server" BarBorderCssClass="" BehaviorID="txtPassword_PasswordStrength" DisplayPosition="LeftSide" MinimumLowerCaseCharacters="1" MinimumNumericCharacters="4" PreferredPasswordLength="7" TargetControlID="txtPassword" TextCssClass="alert-danger">
        ...
        $(document).ready(function () {
            ...
            $('#txtUserName').keyup(function () {
                ...
                if (userName.length >= 3) {
                    $.ajax({
                        url: 'regestierationService.asmx/UserNameExists',
                        method: 'post',
